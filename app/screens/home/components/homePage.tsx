...
export default function HomePage({ navigation }: TScreenProp) {
    return (
        <ScrollView contentContainerStyle={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={{ color: "grey", fontFamily: "Poppins-Normal" }}>
                    May 19,2022
                </Text>
            ...
            <View style={styles.upcomingSchedule}>
                ...
                >
                    ...
                    <MaterialIcons
                        ...
                        size={20}
                        color="#91B48C"
                        onPress={() => navigation.push("Reservist")}
                    />
                </View>
                <View>
                    <View
            ...
            <View style={styles.hazardReporting}>
                <Image
                    source={require("../../../assets/hazard/hazard.png")}
                ...
                >
                    You are currently not in or near any hazard zone
                </Text>
                <TouchableOpacity
                    containerStyle={{
                        width: "40%",
                    ...
                    onPress={() => navigation.navigate("HazardStack")}
                >
                    <Text
                        style={{
                            color: "white",
            ...
            <View style={[styles.hazardReporting, { flexDirection: "column" }]}>
                ...
                >
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => navigation.push("CreateTraining")}
                    >
                        <Text
                            style={{
                                color: "white",
                ...
                >
                    Schedule self-regulated trainings here. Create or join
                    trainings to earn points and redeem benefits!
                </Text>
            </View>

            <View
                style={[
                    styles.hazardReporting,
