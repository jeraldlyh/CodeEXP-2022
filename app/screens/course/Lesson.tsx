...
export default function Lesson() {
    ...
    return (
        < ScrollView contentContainerStyle={[{ padding: 10, alignItems: "center", backgroundColor: '#FCFCFC' }]}>
            <TouchableOpacity style={[{ marginTop: 50, alignSelf: 'flex-start', borderRadius: 20, width: 44, height: 44, backgroundColor: '#A5A5A5', justifyContent: 'center', alignItems: 'center' }]} onPress={() => navigation.pop()}>
                <Icon
            ...
            />
            <Text style={[{ fontSize: 25, fontFamily: 'Poppins-Bold', alignSelf: 'flex-start', marginTop: 50 },]}>Conditions and loops</Text>
            ...
            <Text style={[{ marginTop: 30, width: "100%", fontSize: 15, fontFamily: 'Poppins-Normal', color: "#7A7A7C" }]}>
